...
public class AddPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       EventNameXX=i.getStringExtra("EventNameXX");
        ...
        getSupportActionBar().setTitle("Start a Request");
        ...
        if(EventKeyX==null){
            post_hints.add(new PostHintsModel(R.drawable.ic_remember,"AC not working."));
            post_hints.add(new PostHintsModel(R.drawable.ic_sad,"I am feeling sad, cheer me up."));
            post_hints.add(new PostHintsModel(R.drawable.ic_made,"Room Service Immediately."));
            post_hints.add(new PostHintsModel(R.drawable.ic_friendship,"Room cleaning required?"));
            post_hints.add(new PostHintsModel(R.drawable.ic_handshake,"Need a water bottle."));
        }
        else{
    ...
    public void publishPost(){
        ...
        if (blogs.length() == 0) {
            Toast.makeText(AddPost.this, "Field cannot be empty", Toast.LENGTH_LONG).show();
        } else {
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int i) {
            ...
            holder.ParentView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                     ...
                     initializeEditText();
                     Toast.makeText(AddPost.this,"Click \"ADD\" to proceed",Toast.LENGTH_SHORT).show();
