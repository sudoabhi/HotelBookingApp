...
public class MailActivity extends AppCompatActivity {
                                                ...
                                                if (dataSnapshot.child(currentUser.getUid()).hasChild("UserType")) {
                                                    ...
                                                    if (user_type.equals("Student")) {
                                                        ...
                                                        if (reg.equals("True")) {
                                                            ...
                                                            Intent intent = new Intent(MailActivity.this, SignUpActivity2.class);
                                                            startActivity(intent);
                                                            remove();
                                                            finishAffinity();
                                                        }
                                                    ...
                                                    ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(MailActivity.this);
                                                    startActivity(new Intent(getApplicationContext(), SignUpActivity2.class), options.toBundle());
                                                    progressBar.setVisibility(View.INVISIBLE);
                                                    remove();
                                                    finish();
                                                }
                                                ...
                                                adminReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                    ...
                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                        if(dataSnapshot.hasChild(currentUser.getUid())&&dataSnapshot.child(currentUser.getUid()).hasChild("Registered")) {
                                                            ...
                                                            if (reg.equals("True")) {
                                                                Toast.makeText(getApplicationContext(), "This Email ID is already registered by another user on hotello admin app.",
                                                                        Toast.LENGTH_SHORT).show();
                                                                progressBar.setVisibility(View.INVISIBLE);
                                                                remove();
                                                                return;
    ...
    public void buttonchange() {
        if (email.getText().toString().equals("") || password.getText().toString().equals("")) {
            ...
            login.setBackgroundTintList(ContextCompat.getColorStateList(getApplicationContext(), R.color.buttonEnable2));
