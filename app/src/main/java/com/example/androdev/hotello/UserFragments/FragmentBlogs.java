...
public class FragmentBlogs extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable final Bundle savedInstanceState) {
        ...
        blog_reference = FirebaseDatabase.getInstance().getReference();
        blog_reference2 = FirebaseDatabase.getInstance().getReference();
        blog_reference=blog_reference.child("Blogs");
        blog_reference2=blog_reference2.child("HotelierBlogs");
   ...
   /* @Override
    ...
    class BlogAdapter extends RecyclerView.Adapter<com.example.androdev.hotello.UserFragments.FragmentBlogs.BlogAdapter.MyViewHolder> {
        ...
        @Override
        public com.example.androdev.hotello.UserFragments.FragmentBlogs.BlogAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                                                                 int viewType) {
        ...
        @Override
        public void onBindViewHolder(@NonNull final com.example.androdev.hotello.UserFragments.FragmentBlogs.BlogAdapter.MyViewHolder holder, final int position) {
    ...
    class BlogAdapter2 extends RecyclerView.Adapter<com.example.androdev.hotello.UserFragments.FragmentBlogs.BlogAdapter2.MyViewHolder> {
        ...
        @Override
        public com.example.androdev.hotello.UserFragments.FragmentBlogs.BlogAdapter2.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                                                                 int viewType) {
        ...
        // Replace the contents of a view (invoked by the layout manager)
        @Override
        public void onBindViewHolder(@NonNull final com.example.androdev.hotello.UserFragments.FragmentBlogs.BlogAdapter2.MyViewHolder holder, final int position) {
