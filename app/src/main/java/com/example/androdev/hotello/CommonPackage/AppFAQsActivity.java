...
public class AppFAQsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        questions.add("What is hotello.in?");
        answers.add("hotello.in is a small and diverse group of event lovers on a mission to help organizers by enabling them " +
                "to reach a wider audience and providing them with the right tools to conveniently sell their tickets " +
                "and track the sales!");

        questions.add("How can hotello.in help an event organizer?");
        answers.add("We, at hotello.in, know how much effort goes into making an event successful and we try to make it easier for you!\n" +
